python baseline_train.py --batch-size 32 --epochs 2 --lr 0.0001 --model sub_1stage --sublabel label --wandb True --seed 1004 --tag 1stage --project-name BMC_vision_classification
